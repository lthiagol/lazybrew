...
>
> **Last cleaned:** 2026-06-15 — resolved B-02 into M24/M27; created M25, M26, M27 for debug-log findings; previously resolved B-03, B-04, B-05, B-06, B-08, B-10.
...
| ID | Item | Resolution |
|----|------|-----------|
| B-02 | Lazy panel loading (fetch active panel first) | Covered by **M24** (Outdated) and **M27** (all panels, tiered refresh). |
